...
namespace CoinWin.DataGeneration
{
    ...
    /// </summary>
    public class ExchageDataModel
    {
        public ExchageDataModel()
        {
            this.ID = 0;
    ...
    public class ExchageDataModelMapper : ClassMapper<ExchageDataModel>
    {
        public ExchageDataModelMapper()
        {
            Table("Coin_ExchageData");
            Map(m => m.ID)
