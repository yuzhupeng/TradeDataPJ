...
namespace GetTradeHistoryData
{
    ...
    /// </summary>
    public class BaseSockets : IWebsocket
    {
        ...
        public BaseSockets(  string url) : this( url, new Dictionary<string, string>(), new Dictionary<string, string>())
        {
        }
        ...
        public BaseSockets(  string url, IDictionary<string, string> cookies, IDictionary<string, string> headers)
        {
            Id = NextStreamId();
