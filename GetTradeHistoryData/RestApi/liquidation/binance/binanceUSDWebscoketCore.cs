...
namespace GetTradeHistoryData
{
    ...
    /// 币安   
    /// </summary>
    public class binanceUSDWebscoketCore : IDisposable
    {
        //日志管理
        ...
        public binanceUSDWebscoketCore(string url,string code)
        {
            ...
            do
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        {
                            //ServerPath = "wss://fstream.binance.com/ws/!forceOrder@arr";//U本位
                            Console.WriteLine("binance U本位 度当前状态" + this._webSocket.ReadyState + "-----"   + DateTime.Now.ToString());
                        }
                        else
                        {
                            //ServerPath = "wss://dstream.binance.com/ws/!forceOrder@arr";//币本位
                            Console.WriteLine("binance 币本位 度当前状态" + this._webSocket.ReadyState + "-----"   + DateTime.Now.ToString());
                        }
                    }
                }
                catch (Exception ex)
                {
                    ...
                    {
                        //ServerPath = "wss://fstream.binance.com/ws/!forceOrder@arr";//U本位
                        Console.WriteLine("binance U本位 重连websocket_Error" + this._webSocket.ReadyState + "-----" + DateTime.Now.ToString());
                    }
                    else
                    {
                        //ServerPath = "wss://dstream.binance.com/ws/!forceOrder@arr";//币本位
                        Console.WriteLine("binance 币本位 重连websocket_Error" + this._webSocket.ReadyState + "-----" + DateTime.Now.ToString());
                    }
